...
module ppincl
  ...
  !> Ionic concentration of species \f$ A_L^+ \f$
  ! TODO Concentration de l'espèce AL+
  integer, save :: inpl

  !> Ionic concentration of species \f$ B_L^- \f$
  ! TODO Concentration de l'espèce BL-
  integer, save :: innl

  !> Ionic concentration of species \f$ A_LB_L \f$
  ! TODO Concentration de l'espèce ALBL
  integer, save :: inl

  !> Ionic concentration of species \f$ C_S^+ \f$
  ! TODO Concentration de l'espèce CS+
  integer, save :: inps

  !> Ionic concentration of species \f$ D_S^- \f$
  ! TODO Concentration de l'espèce DS-
  integer, save :: inns

  !> Ionic concentration of species \f$ C_SD_S \f$
  ! TODO Concentration de l'espèce CSDS
  integer, save :: ins

  !> Ionic concentration of species \f$ C_SB_L \f$
  ! TODO Concentration de l'espèce CSBL
  integer, save :: insln

  !> Ionic concentration of species \f$ D_SA_L \f$
  ! TODO Concentration de l'espèce DSAL
  integer, save :: inslp

  !> Divergence of current density for \f$ A_L^+\f$, \f$ B_L^-\f$, \f$ C_S^+\f$, \f$ D_S^-\f$
  ! TODO Divergence de la densité de courant des espèces chargées
  integer, save :: idivjpl, idivjnl, iduvjps, idivjns

  !> Electric field \f$ E_L \f$
  ! TODO Champ électrique
  integer, save :: ichele

  !> Current density vector \f$ D_SA_L \f$
  ! TODO Vecteur densité de courant
  integer, save :: ij(ndivme)

  !> Displacement Current density vector \f$ D_SA_L \f$
  ! TODO Vecteur densité de courant
  integer, save :: ijdep(ndivme)
