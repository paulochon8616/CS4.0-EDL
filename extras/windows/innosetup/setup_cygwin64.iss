...
OutputBaseFilename={#MyAppName} {#MyAppVersionFull} win64
Compression=lzma
...
Source: "{#Cygwin}\bin\cygisl-10.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\bin\cygcloog-isl-4.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\zlib1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libwinpthread-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\liblzma-5.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
; Windows CRT DLL
...
; GCC runtime
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libgfortran-3.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libgcc_s_seh-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libquadmath-0.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libquadmath-0.dll"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: core
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libstdc++-6.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: core
; GCC executables
...
Source: "{#Cygwin}\bin\x86_64-w64-mingw32-cpp.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\bin\x86_64-w64-mingw32-c++.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\bin\x86_64-w64-mingw32-g++.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\bin\x86_64-w64-mingw32-gfortran.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\bin\x86_64-w64-mingw32-gcc.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\bin\libgomp-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
...
Source: "{#Cygwin}\bin\cyggcc_s-seh-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\bin\cygwin1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}\*.*"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}\include\*"; DestDir: "{app}\include"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: dev\gcc
Source: "{#Cygwin}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}\*"; DestDir: "{app}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libadvapi32.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libkernel32.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libuser32.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libshell32.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libz.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libm.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\gcc
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\bin\*"; DestDir: "{app}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}"; Flags: ignoreversion; Components: dev\gcc
; Binutils
...
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\include\*"; DestDir: "{app}\include"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\*.o"; DestDir: "{app}\lib\gcc\x86_64-w64-mingw32\{#GCC_VERSION}"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libcrtdll.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libgmon.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libm.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmingw32.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmingwex.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmingwthrd.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmoldname.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcr100.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcr110.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcr80.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcr90.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcr90d.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
Source: "{#Cygwin}\usr\x86_64-w64-mingw32\sys-root\mingw\lib\libmsvcrt.a"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: dev\system
; Pre-requisites
#if HAVE_CGNS == "yes"
